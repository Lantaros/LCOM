...
#define TRANSPARENT_PIXEL 0x2FE0
 ...
 */
void drawBitmap(char* video_buff, Bitmap* bitmap, int x, int y, Alignment alignment);
...
/**
*@brief Detroys all the bitmaps from a given array
*
*@param arrray array that will be deleted
*/
